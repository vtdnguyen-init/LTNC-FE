          ...
          <table id="basic-table" className="min-w-full overflow-hidden">
            <thead>
              <tr className="bg-gray-100 dark:bg-dark-bg">
                ...
                <th className="px-6 text-gray-500 py-4 whitespace-nowrap text-left dark:text-slate-900">BRAND</th>
                <th className="px-6 text-gray-500 py-4 whitespace-nowrap text-left dark:text-slate-900">ORIGIN</th>
                <th className="px-6 text-gray-500 py-4 whitespace-nowrap text-left dark:text-slate-900">AMMOUNT</th>
                <th className="px-6 text-gray-500 py-4 whitespace-nowrap text-left dark:text-slate-900">EXPIRED DATE</th>
                <th className="px-6 text-gray-500 py-4 whitespace-nowrap text-left dark:text-slate-900">PRICE PER BOX</th>
              ...
              <tr className="dark:bg-dark-strip">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">Panadol</h6>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">GSK</h6>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap ">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">Ireland</h6>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">2341</h6>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">2027/3/24</h6>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">$70</h6>
                  </div>
                </td>
