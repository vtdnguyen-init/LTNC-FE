          ...
          <table id="basic-table" className="min-w-full overflow-hidden">
            <thead>
              <tr className="bg-gray-100 dark:bg-dark-bg">
                ...
                <th className="px-6 text-gray-500 py-4 whitespace-nowrap text-left dark:text-slate-900">Gender</th>
                ...
                <th className="px-6 text-gray-500 py-4 whitespace-nowrap text-left dark:text-slate-900">LASTEST</th>
                <th className="px-6 text-gray-500 py-4 whitespace-nowrap text-left dark:text-slate-900">CONTACT</th>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
              <tr className="dark:bg-dark-strip">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">Male</h6>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap ">
                  <div className="flex items-center">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">38-345-2343</h6>
                  </div>
                </td>
              ...
              <tr className="bg-gray-100 dark:bg-dark-card">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">23-456-789</h6>
                  </div>
                </td>
                <td className="px-7 py-4 whitespace-nowrap">
                  <div className="flex items-right">
              ...
              <tr className="dark:bg-dark-strip">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">Pigeon</h6>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap ">
                  <div className="flex items-center">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <h6 className="text-base dark: text-blue-950">87-874-9872</h6>
                  </div>
                </td>
                <td className="px-7 py-4 whitespace-nowrap">
                  <div className="flex items-right">
