      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
            <g data-name="30-doctor">
              <path
                d="M14 20a12.8 12.8 0 0 0 .16 1.98L14 22h-1a3 3 0 0 1-3-3 3.011 3.011 0 0 1 3-3h1z"
                style={{ fill: "#ffbeaa" }}
              />
              <path
                d="M11 19a3.011 3.011 0 0 1 3-3h-1a3 3 0 0 0 0 6h1a3 3 0 0 1-3-3zM34 20a12.8 12.8 0 0 1-.16 1.98L34 22h1a3 3 0 0 0 3-3 3.011 3.011 0 0 0-3-3h-1z"
                style={{ fill: "#ffcdbe" }}
              />
              <path
                d="M37 16.77a2.965 2.965 0 0 0-2-.77h-1a3 3 0 0 1 0 6h1a3 3 0 0 0 3-3 2.94 2.94 0 0 0-1-2.23z"
                style={{ fill: "#ffdecf" }}
              />
              <path
                d="M30 29v4l-6 4-6-4v-4l.09-.12a9.3 9.3 0 0 0 11.82 0z"
                style={{ fill: "#ffcdbe" }}
              />
              <path
                d="M34 16.85V20a11.539 11.539 0 0 1-2.93 7.78 10.944 10.944 0 0 1-1.16 1.1 9.3 9.3 0 0 1-11.82 0 11.241 11.241 0 0 1-3.93-6.9A12.8 12.8 0 0 1 14 20v-4.47a2 2 0 0 1 .26-.99L18 8s7.57 5.89 14.23 6.86A2.032 2.032 0 0 1 34 16.85z"
                style={{ fill: "#ffcdbe" }}
              />
              <path
                d="M32.23 14.86C25.57 13.89 18 8 18 8l-2 3.5-1.74 3.04a2 2 0 0 0-.26.99V20a12.8 12.8 0 0 0 .16 1.98 11.241 11.241 0 0 0 3.93 6.9A9.389 9.389 0 0 0 24 31a9.193 9.193 0 0 0 1-.061 9.443 9.443 0 0 1-4.91-2.059 11.241 11.241 0 0 1-3.93-6.9A12.8 12.8 0 0 1 16 20v-4.44a4 4 0 0 1 .528-1.985L18 11s7.57 5.89 14.23 6.86A2.032 2.032 0 0 1 34 19.85v-3a2.032 2.032 0 0 0-1.77-1.99z"
                style={{ fill: "#ffbeaa" }}
              />
              <path
                d="M32.23 17.86c-.076-.011-.154-.031-.23-.043V20a11.539 11.539 0 0 1-2.93 7.78 10.944 10.944 0 0 1-1.16 1.1A9.443 9.443 0 0 1 23 30.939 9.193 9.193 0 0 0 24 31a9.389 9.389 0 0 0 5.91-2.12 10.944 10.944 0 0 0 1.16-1.1A11.539 11.539 0 0 0 34 20v-.15a2.032 2.032 0 0 0-1.77-1.99z"
                style={{ fill: "#ffdecf" }}
              />
              <path
                d="M32.23 14.86c-.076-.011-.154-.031-.23-.043v3c.076.012.154.032.23.043A2.032 2.032 0 0 1 34 19.85v-3a2.032 2.032 0 0 0-1.77-1.99z"
                style={{ fill: "#ffcdbe" }}
              />
              <path
                d="M24 33a9.174 9.174 0 0 1-1.876-.2 7.005 7.005 0 0 0 3.833 2.9L30 33v-2.2l-.09.079A9.389 9.389 0 0 1 24 33z"
                style={{ fill: "#ffdecf" }}
              />
              <path
                d="M22.124 32.8a6.954 6.954 0 0 1-.947-2.252 9.611 9.611 0 0 1-3.087-1.668L18 29v1.8c.031.025.059.055.09.08a9.519 9.519 0 0 0 4.034 1.92z"
                style={{ fill: "#faa68e" }}
              />
              <path
                d="M29.91 28.88A9.389 9.389 0 0 1 24 31a9.149 9.149 0 0 1-2.823-.453 6.954 6.954 0 0 0 .947 2.252A9.174 9.174 0 0 0 24 33a9.389 9.389 0 0 0 5.91-2.12l.09-.079V29z"
                style={{ fill: "#ffbeaa" }}
              />
              <path
                d="M34 16v.85a2.032 2.032 0 0 0-1.77-1.99C25.57 13.89 18 8 18 8l-3.74 6.54a2 2 0 0 0-.26.99V16h-1a2.965 2.965 0 0 0-2 .77V14a13 13 0 0 1 26 0v2.77a2.965 2.965 0 0 0-2-.77z"
                style={{ fill: "#192b44" }}
              />
              <path
                d="M36.948 12.968a12.966 12.966 0 0 0-18.8-10.562c1.12 5.761 9.022 10.257 18.8 10.562z"
                style={{ fill: "#2b3e5b" }}
              />
              <path
                d="M11.788 9.583A12.916 12.916 0 0 0 11 14v2.77a2.965 2.965 0 0 1 2-.77h1v-3s-.008-1.629-2.212-3.417z"
                style={{ fill: "#112135" }}
              />
              <path style={{ fill: "#4f7fff" }} d="m26 43 1 4h-6l1-4h4z" />
              <path
                style={{ fill: "#4f7fff" }}
                d="m24 37 5.74 4.78L28 47h-1l-1-4h-4l-1 4h-1l-1.74-5.22L24 37z"
              />
              <path
                style={{ fill: "#edf2ff" }}
                d="m29.74 41.78 2.12-6.35 5.22 1.23L37 37v7h-4l4 3h-9l1.74-5.22zM18.26 41.78 20 47h-9l4-3h-4v-7l-.08-.34 5.22-1.23 2.12 6.35z"
              />
              <path
                d="M47 43.75V47H37l-4-3h4v-7l.08-.34 5.29 1.25A6.009 6.009 0 0 1 47 43.75zM11 44h4l-4 3H1v-3.25a6.009 6.009 0 0 1 4.63-5.84l5.29-1.25.08.34z"
                style={{ fill: "#e8eeff" }}
              />
              <path
                style={{ fill: "#ccd7f2" }}
                d="M38 45v-8.123l-.92-.217L37 37v7h-4l4 3h2l-3-2h2zM10 45v-8.123l.92-.217.08.34v7h4l-4 3H9l3-2h-2z"
              />
              <path
                style={{ fill: "#376dff" }}
                d="m26.824 41.352.706-1.412L24 37l-3.53 2.94.706 1.412L24 39l2.824 2.352z"
              />
              <path
                d="m18 33 6 4-5.74 4.78-2.12-6.35.32-.07A2 2 0 0 0 18 33.42zM30 33v.42a2 2 0 0 0 1.54 1.94l.32.07-2.12 6.35L24 37z"
                style={{ fill: "#e8eeff" }}
              />
              <path
                style={{ fill: "#bccced" }}
                d="M27.53 39.94 26 43l1 4h1l1.74-5.22-2.21-1.84zM20.47 39.94l-2.21 1.84L20 47h1l1-4-1.53-3.06z"
              />
              <path
                style={{ fill: "#376dff" }}
                d="M26 43h-4l-.25 1h4.5L26 43z"
              />
              <path
                d="M17.04 35.119a1.971 1.971 0 0 1-.58.241l-.32.07 2.12 6.35.783-.652zM29.74 41.78l2.12-6.35-.32-.07a1.971 1.971 0 0 1-.58-.241l-2 6.009z"
                style={{ fill: "#ccd7f2" }}
              />
              <path
                style={{ fill: "#a7bfe8" }}
                d="M28.957 41.128 27.53 39.94l-.354.707 1.52 1.266L27 47h1l1.478-4.435.262-.785-.783-.652zM19.304 41.913l1.52-1.266-.354-.707-1.427 1.188-.783.652.262.785L20 47h1l-1.696-5.087z"
              />
              <path
                style={{ fill: "#f7f9ff" }}
                d="m32.205 38.702 2.35.608 2.445.629V37l.08-.34-5.22-1.23-.928 2.779 1.273.493zM11 39.852l6.05-1.695-.91-2.727-5.22 1.23.08.34v2.852zM47 43.75a6.009 6.009 0 0 0-4.63-5.84l-5.29-1.25.92.217V40.2l2.773.713A5.923 5.923 0 0 1 45 46.75V47h2zM7.227 40.91 10 40.133v-3.256l.92-.217-5.29 1.25A6.009 6.009 0 0 0 1 43.75V47h2v-.25a5.923 5.923 0 0 1 4.227-5.84z"
              />
              <path
                style={{ fill: "#dde4f7" }}
                d="m37 39.939 1 .258v-3.32l-.92-.217L37 37v2.939zM10 40.133l1-.281V37l-.08-.34-.92.217v3.256z"
              />
              <path
                d="m17.959 37.876 4.805-1.7L18 33v.42a2 2 0 0 1-.96 1.7zM30.96 35.119a2 2 0 0 1-.96-1.7V33l-4.764 3.176 4.805 1.7z"
                style={{ fill: "#edf2ff" }}
              />
              <path
                d="m17.609 38 .35-.124-.919-2.757a1.971 1.971 0 0 1-.58.241l-.32.07.91 2.727zM30.041 37.876l.35.124.541.209.928-2.779-.32-.07a1.971 1.971 0 0 1-.58-.241z"
                style={{ fill: "#dde4f7" }}
              />
              <ellipse
                cx="29.5"
              ...
              <ellipse
                ...
                rx="1.642"
                ry="2.286"
                transform="rotate(-45.02 32.002 9.987)"
                style={{ fill: "#f6fafd" }}
              />
              <ellipse
                cx="24.746"
                ...
                rx=".413"
                ry=".574"
                transform="rotate(-45.02 24.745 40.5)"
                style={{ fill: "#f6fafd" }}
              />
            </g>
          </svg>
